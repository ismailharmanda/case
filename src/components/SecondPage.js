...
const SecondPage = () => {
  return (
    <div
      className="pt-5 mt-5 mb-5 mb-md-0 pb-5"
      style={{ background: "#BDD7FE", height: "1100px" }}
    >
      <div className="container mt-5 pt-5">
        <div className="row d-flex justify-content-between">
          <div className="col-12 col-md-6">
            ...
            >
              {" "}
              The world today seems to run on apps. If it is something that
              people can interact with, then it’s likely that there is an app
              available for it.
            </p>
