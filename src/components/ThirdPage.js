...
const ThirdPage=()=>{
  ...
  <div class="carousel-inner">
    ...
    <div className="row mt-5 pt-5 justify-content-center">
            ...
            <div className="col-1 col-md-1"><Quote /></div>
  ...
  <a style={{filter: "invert(100%)"}} className="carousel-control-prev" href="#carouselExampleControls" role="button" data-slide="prev">
    <span className="carousel-control-prev-icon" aria-hidden="true"></span>
    <span className="sr-only">Previous</span>
  </a>
  <a style={{filter: "invert(100%)"}} className="carousel-control-next" href="#carouselExampleControls" role="button" data-slide="next">
